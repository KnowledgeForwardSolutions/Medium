...
namespace CheckDigits.Tests.Unit.IsinAlgorithmVersions;

public class IsinAlgorithmV4Tests
{
   [Theory]
   ...
   public void ValidateCheckDigit_ShouldReturnTrue_WhenValueContainsValidCheckDigit(string value)
      => IsinAlgorithmV4.ValidateCheckDigit(value).Should().BeTrue();
   ...
   public void ValidateCheckDigit_ShouldReturnFalse_WhenValueContainsDetectableError(string value)
      => IsinAlgorithmV4.ValidateCheckDigit(value).Should().BeFalse();
