...
public class Mod37_2V3Tests
{
   private static readonly Mod37_2V3 _sut = new();
   ...
   [InlineData("A999922654321S")]         // "
   [InlineData("A999914123456N")]         // Example ISBT from https://www.isbt128.org/_files/ugd/83d6e1_9c7ba55fbdd44a80947bc310cdd92382.pdf
   public void Validate_Alphabet_ShouldReturnTrue_WhenInputContainsValidCheckCharacters(String input)
      => _sut.Validate_Alphabet(input).Should().BeTrue();
   ...
   [InlineData("HA999922123459")]         // A999922123459H with circular shift error
   [InlineData("999922123459HH")]         // A999922123459H with circular shift error
   public void Validate_Alphabet_ShouldReturnFalse_WhenInputContainsDetectableError(String input)
      => _sut.Validate_Alphabet(input).Should().BeFalse();

   [Theory]
   [InlineData("A999922123459H")]         // Example ISBT from https://www.isbt128.org/_files/ugd/79eb0b_1a92d4e286af404183d03bf5bab9120f.pdf 
   [InlineData("A999922654321S")]         // "
   [InlineData("A999914123456N")]         // Example ISBT from https://www.isbt128.org/_files/ugd/83d6e1_9c7ba55fbdd44a80947bc310cdd92382.pdf
   public void Validate_Reduce_ShouldReturnTrue_WhenInputContainsValidCheckCharacters(String input)
      => _sut.Validate_Reduce(input).Should().BeTrue();
   ...
   [InlineData("HA999922123459")]         // A999922123459H with circular shift error
   [InlineData("999922123459HH")]         // A999922123459H with circular shift error
   public void Validate_Reduce_ShouldReturnFalse_WhenInputContainsDetectableError(String input)
      => _sut.Validate_Reduce(input).Should().BeFalse();

   [Theory]
   [InlineData("A999922123459H")]         // Example ISBT from https://www.isbt128.org/_files/ugd/79eb0b_1a92d4e286af404183d03bf5bab9120f.pdf 
   [InlineData("A999922654321S")]         // "
   [InlineData("A999914123456N")]         // Example ISBT from https://www.isbt128.org/_files/ugd/83d6e1_9c7ba55fbdd44a80947bc310cdd92382.pdf
   public void Validate_LocalAlphabet_ShouldReturnTrue_WhenInputContainsValidCheckCharacters(String input)
      => _sut.Validate_LocalAlphabet(input).Should().BeTrue();
   ...
   [InlineData("HA999922123459")]         // A999922123459H with circular shift error
   [InlineData("999922123459HH")]         // A999922123459H with circular shift error
   public void Validate_LocalAlphabet_ShouldReturnFalse_WhenInputContainsDetectableError(String input)
      => _sut.Validate_LocalAlphabet(input).Should().BeFalse();
}
