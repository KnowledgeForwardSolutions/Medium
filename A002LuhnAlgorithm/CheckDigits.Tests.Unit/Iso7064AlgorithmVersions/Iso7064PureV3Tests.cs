...
public class Iso7064PureV3Tests
{
   private static readonly IValidator _mod11_2 = new Iso7064PureV3(new DigitsSupplementalAlphabet(), 11, 2);
   private static readonly IValidator _mod1271_36 = new Iso7064PureV3(new AlphanumericAlphabet(), 1271, 36);
   private static readonly IValidator _mod37_2 = new Iso7064PureV3(new AlphanumericSupplementalAlphabet(), 37, 2);
   private static readonly IValidator _mod661_26 = new Iso7064PureV3(new LettersAlphabet(), 661, 26);
